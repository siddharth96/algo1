...
public class Point implements Comparable<Point> {
    ...
    public static void main(String[] args) {
     ...
     reference p.slopeTo(q)    = 4.03030303030303
     reference p.slopeTo(r)    = 3.9518072289156625
         */
        Point p = new Point(23014, 29858);
        Point q = new Point(3301, 12662);
        Point r = new Point(28450, 22834);
